...
public class SaveMethod {
    public static void main(String[] args) {
        ...
        //if an INSERT has to be executed to get the identifier (e.g. "identity" generator, not "sequence"), this INSERT happens immediately),
        //May not fire insert query on this line, it will add insert query in insertionList of session's ActionQueue later it will execute all the queries from this list
